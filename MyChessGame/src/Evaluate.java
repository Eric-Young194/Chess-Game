...
public class Evaluate {
	...
	//Boards state the value of position on the board in context to each piece.
    ...
    public static boolean MATERIAL = true;			// Material Evaluation Flag
    public static boolean ATTACK = true;			// Attack Evaluation Flag
    public static boolean MOVABILITY = true;		// Movability Evaluation Flag
    public static boolean POSITIONAL = true;		// Positional Evaluation Flag
	 ...
	 * @param  int listLength, int depth
